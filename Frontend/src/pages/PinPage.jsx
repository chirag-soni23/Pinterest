      ...
      {pin && (
        <div className='flex flex-col items-center bg-gray-100 p-4 min-h-screen'>
          {loading ? (
            ...
            <div className='bg-white rounded-lg shadow-lg flex md:flex-row w-full max-w-4xl'>
              ...
              <div className="w-full md:w-1/2 p-6 flex flex-col">
                ...
                <div className="flex items-center mt-4">
                  ...
                  <form onSubmit={submitHandler} className='flex-1 flex'>
                    <input
                      ...
                      type="text"
                    />
                    <button type='submit' className='ml-2 bg-red-500 px-4 py-2 text-white'>Add+</button>
                  </form>
                </div>
